...
exports.genre_delete_post = function(req, res) {
  async.parallel({
    ...
    if (results.genres_books.length > 0) {
        ...
        res.render('author_delete', { title: 'Delete genre', genre: results.genre, genre_books: results.genres_books } );
        return;
    }
    else {
        // Genre has no books. Delete object and redirect to the list of renges.
